temp = textread('data\climdiv-tmpcdv-v1.0.0-20200804');
phdi = textread('data\climdiv-phdidv-v1.0.0-20200804');
pcpn = textread('data\climdiv-pcpndv-v1.0.0-20200804');
pdsi = textread('data\climdiv-pdsidv-v1.0.0-20200804');
zndx = textread('data\climdiv-zndxdv-v1.0.0-20200804');
...
save('climate.mat', 'X', 'Z', 'Y', 'division_index');